...
- [(Rust)Operator expressions](#operator-expressions)
- [Operators in C and C++](https://en.wikipedia.org/wiki/Operators_in_C_and_C%2B%2B)

<hr />

- [https://doc.rust-lang.org/reference/expressions/operator-expr.html](https://doc.rust-lang.org/reference/expressions/operator-expr.html)

# Operator expressions[|🔝|](#link)
